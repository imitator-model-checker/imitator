...
\usepackage[pdftex,plainpages=false,bookmarksnumbered,
  pdfdisplaydoctitle=true,bookmarks,breaklinks,
  linktocpage,colorlinks,citecolor=blue,pdfstartview=FitH]{hyperref}
...
% The tool \imitator{} is available on its Web page\footnote{\mbox{\url{http://www.lsv.ens-cachan.fr/~andre/IMITATOR2}}}.
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The cartography computed by \imitator{} is given in Figure~\ref{fig:cartography_rcp}.
