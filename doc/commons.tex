...
\fancyhead[r]{%
	...
	\includegraphics[height=1em]{../logos/logo-3-3-300.png}
}
...
% Current version
\newcommand{\imitatorversion}{3.3-alpha}
\newcommand{\imitatorversionname}{Cheese Caramel au beurre salé}
...
\lstdefinestyle{IMITATORmodel}{
	...
	morekeywords={
		accepting, and, array, automaton, binary, bool, clock, constant, continuous, discrete, do, end, False, fill_left, fill_right, flow, forward, from, goto, if, in, init, int, initially, invariant, loc, logand, lognot, logor, logxor, not, or, parameter, projectresult, rational, shift_left, shift_right, stop, sync, sync, synclabs, True, urgent, var, when, while
	},
