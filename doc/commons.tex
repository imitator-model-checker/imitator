...
\lstdefinestyle{IMITATORmodel}{
	...
	morekeywords={
		and, automaton, binary, clock, constant, continuous, discrete, do, end, False, fill_left, fill_right, flow, forward, from, goto, if, in, init, int, initially, invariant, loc, logand, lognot, logor, logxor, not, or, parameter, rational, shift_left, shift_right, stop, sync, sync, synclabs, True, urgent, var, when, while
	},
...
%   firstnumber=1000,                % start line enumeration with line 1000
  ...
  keywordstyle=\bfseries\color{blue},       % keyword style
%   language=caml,                 % the language of the code
  morekeywords={always,everytime,eventually,loc,property,sequence,synth,within,witness},            % if you want to add more keywords to the set
