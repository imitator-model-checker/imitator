...
\lstdefinestyle{IMITATORmodel}{
	...
	morekeywords={
		accepting, and, automaton, binary, clock, constant, continuous, discrete, do, end, False, fill_left, fill_right, flow, forward, from, goto, if, in, init, int, initially, invariant, loc, logand, lognot, logor, logxor, not, or, parameter, rational, shift_left, shift_right, stop, sync, sync, synclabs, True, urgent, var, when, while
	},
...
%   firstnumber=1000,                % start line enumeration with line 1000
  ...
  keywordstyle=\bfseries\color{blue},       % keyword style
%   language=caml,                 % the language of the code
  morekeywords={accepting, AGnot, always, BCcover, BCrandom, BCshuffle, Cycle, CycleThrough, DeadlockFree, EF, EFpmin, EFpmax, EFtmin, everytime,eventually, IM, loc, pattern, PRP, PRPC, property,sequence,synth,within,witness},            % if you want to add more keywords to the set
...
%   stringstyle=\color{bggcolor},     % string literal style
%   tabsize=2,	                   % sets default tabsize to 2 spaces
...
\definecolor{commentscolor}{rgb}{0.6,0.6,0.6}
\definecolor{numberscolor}{rgb}{0.3,.3,0.3}
\definecolor{stringscolor}{rgb}{.6,1,0.6}
...
% 	numberstyle=\tiny\color{numberscolor}, % the style that is used for the line-numbers
	...
	inputencoding=utf8,
    extendedchars=true,
    literate={á}{{\'a}}1 {à}{{\`a}}1 {ã}{{\~a}}1 {é}{{\'e}}1 {è}{{\`e}}1 {ê}{{\^e}}1,
}
