...
\emph{Rational variables} are rational-valued variables, and were described in \cref{subsection:rational}.
...
Contrarily to arrays, the type of a list does not depend on its length; it is therefore possible to compare two lists of different lengths.
...
For example, it is possible to declare a list of integers, of Booleans, or of list of array of Booleans.
...
For example, it is possible to declare a stack of integers, of Booleans, of stacks of list of Booleans.
...
For example, it is possible to declare a queue of integers, of Booleans, or of stacks of binary words.
\begin{remark}
...
\begin{remark}
Some functions, called ``Side-effects functions'' allow the modification of collections ``in-place'' and therefore are subject to side-effects.
...
The presence of clocks and parameters, discrete variables, and structures (such as arrays) require a particular handling of the updates, which we describe in the following.

In any case, the paradigm is that discrete variables are first tested, then updated.
...
% TODO: here, something general on updates is missing

%------------------------------------------------------------
\subsubsection{do-then form updates}\label{section:do_then_form_updates}
%------------------------------------------------------------
...
Update of a discrete variable constraint is equivalent to an assignment. However, these updates are not sequential,
