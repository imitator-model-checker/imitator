...
Contrary to \styleIMI{then} bloc (or standard update) it is possible to make in-place modifications on data structures (like stacks and queues) with side-effects functions.
...
It is not possible to update clock constraint in \styleIMI{do} bloc because of the sequential behavior.
