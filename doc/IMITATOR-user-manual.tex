...
User defined functions have zero or many parameters and can return one value.
All function parameters are passed by value.

A user defined function can be compound of declarations, imperative instructions, and one return expression.
