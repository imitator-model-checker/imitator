...
You can refer to the table \cref{table:summary:blocks-characteristics} to get an overview of what's allowed in the \styleIMI{seq} and \styleIMI{then} blocks.
...
\begin{table}[h!]
	\caption{Blocks characteristics summary}
	{\centering
	\small
