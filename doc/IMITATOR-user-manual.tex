...
\begin{itemize}
	\item \styleIMI{list([]):'a list} with \styleIMI{'a:any} - return an empty list
...
\begin{itemize}
	\item \styleIMI{stack():'a stack} with \styleIMI{'a:any} - return an empty stack
	\item \label{item:lbl-stack_push} \styleIMI{stack\_push(e:'a, s:'a stack)} with \styleIMI{'a:any} - Add an element \styleIMI{e} at the top of the stack \styleIMI{s}---the stack is modified, this function is subject to side-effects
	...
	\item \label{item:lbl-stack_clear} \styleIMI{stack\_clear(s:'a stack)} with \styleIMI{'a:any} - Remove all elements of the stack \styleIMI{s}---the stack is modified, this function is subject to side-effects
...
\begin{itemize}
	\item \styleIMI{queue():'a stack} with \styleIMI{'a:any} - return an empty queue
	\item \label{item:lbl-queue_push} \styleIMI{queue\_push(e:'a, q:'a queue)} with \styleIMI{'a:any} - Add an element \styleIMI{e} at the beginning of the queue \styleIMI{q}---the queue is modified, this function is subject to side-effects
	...
	\item \label{item:lbl-queue_clear} \styleIMI{queue\_clear(q:'a queue)} with \styleIMI{'a:any} - Remove all elements of the queue \styleIMI{q}---the queue is modified, this function is subject to side-effects
