...
A stack variable always has an underlying type, which can be any of the available types of \imitator{} (including arrays, lists, stack and queue).
For example, it is possible to declare a stack of integers, of Booleans, of stack of stack of Booleans---which can be seen as a multidimensional stack.
\begin{remark}
...
A queue variable always has an underlying type, which can be any of the available types of \imitator{} (including arrays, lists, stack and queue).
For example, it is possible to declare a queue of integers, of Booleans, of queue of queue of Booleans---which can be seen as a multidimensional queue.
\begin{remark}
...
\begin{remark}
Some function, mistakenly called "Side-effects functions" allow modification of collections "in-place" and therefore are subject to side-effects.
Side-effects functions can only be used in updates.
\end{remark}
