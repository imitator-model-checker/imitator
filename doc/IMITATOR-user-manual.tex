...
\newcommand{\GitHubIMI}{GitHub} % TODO
...
The algorithm implemented in \imitator{} is a basic breadth-first procedure, close to the one described in \cite{AHV93,JLR15}.
...
\imitator{} can also
	...
	or
	output the result to a file (option \styleOption{-output-result}).
