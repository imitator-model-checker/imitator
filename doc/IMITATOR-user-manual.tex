...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Blocks and lexical scope}\label{section:variable_scope}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Reachability (EF)}\label{section:algorithm:EFsynth}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{EF-maximization}\label{section:algorithm:EFmax}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{EF with minimal time reachability}\label{section:algorithm:EFopt}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Exists-until (``EU'' in CTL) denotes that a state predicate holds \emph{until} another state predicate holds.
...
Most remarks for EF (see \cref{section:algorithm:EFsynth}) also hold for EU.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Unavoidability synthesis: AF, AU, AW}\label{section:algorithm:AF}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{enumerate}
	\item Unavoidability-synthesis (``AF'' in CTL), where a state predicate must always eventually hold;
	\item Always-release-synthesis (``AR'' in CTL), where a first state predicate must always eventually release a second state predicate;
	\item Always-until-synthesis (``AU'' in CTL), where a first state predicate must hold until a second state predicate always eventually holds;
	\item Always-weak-until-synthesis (``AW'' in CTL), where a first state predicate must hold until a second state predicate always eventually holds---unless the first one holds forever.
\end{enumerate}

Except for~AR, note that if the second state predicate holds from the first state, the first state predicate does not need to hold.

Also note that $A \varphi R \psi$ is directly implemented as $A \psi W (\varphi \land \psi)$.
