...
\begin{itemize}
    \item \label{item:lbl-pow} \styleIMI{pow(x:'a number, e:int):'a} with \styleIMI{'a number:[rational|int]} - compute the power of a number
\end{itemize}
...
%------------------------------------------------------------
	\begin{IMITATORmodel}
		...
		(* true_bool = True, another_true_bool = True *)
		(* false_bool = False *)
		(* i = 1 *)

		when True goto l1;
		when true_bool = True goto l1;
		when false_bool = False goto l1;
...
Contrarily to arrays, the type of a list does include its length; it is therefore possible to compare two lists of different lengths.
...
\begin{itemize}
	...
	\item \label{item:lbl-list_mem} \styleIMI{list\_mem(e:'a, l:'a list):bool} with \styleIMI{'a:any} - true if \styleIMI{e} belongs to the list~ˇ\styleIMI{l}
...
\begin{itemize}
	\item \label{item:lbl-stack_push} \styleIMI{stack\_push(e:'a, s:'a stack):'a stack} with \styleIMI{'a:any} - Add an element \styleIMI{e} at the top of the stack \styleIMI{s} and return the stack---the stack is modified, this function is subject to side-effects
	...
	\item \label{item:lbl-stack_clear} \styleIMI{stack\_clear(s:'a stack):'a stack} with \styleIMI{'a:any} - Remove all elements of the stack \styleIMI{s} and return the stack---the stack is modified, this function is subject to side-effects
...
\begin{itemize}
	\item \label{item:lbl-queue_push} \styleIMI{queue\_push(e:'a, q:'a queue):'a queue} with \styleIMI{'a:any} - Add an element \styleIMI{e} at the beginning of the queue \styleIMI{q} and return the queue---the queue is modified, this function is subject to side-effects
	...
	\item \label{item:lbl-queue_clear} \styleIMI{queue\_clear(q:'a queue):'a queue} with \styleIMI{'a:any} - Remove all elements of the queue \styleIMI{q} and return the queue---the queue is modified, this function is subject to side-effects
