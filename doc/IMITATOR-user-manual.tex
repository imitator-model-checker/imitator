...
%------------------------------------------------------------
In \styleOption{AccLoopSynthNDFS} with iterative deepening, force re-exploration of
...
%------------------------------------------------------------
Step is used for iterative \styleOption{AccLoopSynthNDFS}: it indicates the step between two iterations.
