...
\begin{table}[h!]
	...
	{\centering
		\begin{tabular}{ | l | l | c | c | c | }
			...
			\hline
			Accepting cycle (NDFS)        & \styleIMI{CycleThrough(state\_predicate)} & \cellNo{} & \styleOption{equality}  \\
			\hline
			Accepting cycle (BFS)        & \styleIMI{CycleThrough(state\_predicate)} & \cellNo{} & \styleOption{including}  \\
			\hline
...
Note that the BFS cycle synthesis uses \styleOption{-comparison including} as default.
