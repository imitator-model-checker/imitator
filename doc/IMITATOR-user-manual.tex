...
%------------------------------------------------------------
\begin{terminal}
-merge reconstruct -merge-candidates queue -merge-update merge -merge-restart off
\end{terminal}
%------------------------------------------------------------
...
\begin{longtable}{@{} l @{\ \ } p{12cm}}
	...
	\styleOption{on-the-fly} & Update the statespace by deleting the merged state and updating its transitions \emph{in situ}~\cite{AMPP22}\\
