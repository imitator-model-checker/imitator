...
% Current version
\newcommand{\imitatorversion}{2.7.1}
...
That is, the system is safe if \styleIMI{delta < gamma}, which is the well-known constraint ensuring mutual exclusion for this protocol.
	% TODO: ref
