...
\begin{itemize}
    \item \styleIMI{pow(x : 'a, e : int) : 'a with 'a : [rational | int]}
\end{itemize}

\subsection{Conversion functions}

\begin{itemize}
    \item \styleIMI{rational\_of\_int(x : int) : rational}
\end{itemize}
...
Theses types are divided into two categories: numerical (for \styleIMI{rational} and \styleIMI{int}) and Booleans (for \styleIMI{bool}).
...
\begin{itemize}
	...
	\item It applies a numerical type to literal numbers according to the numerical type holding by their outer expression;
