...
% Current version
\newcommand{\imitatorversion}{2.6.0}
...
\imitator{}~\cite{AFKS12} (for \emph{Inverse Method for Inferring Time AbstracT behaviOR}) is a tool for parameter synthesis in the framework of real-time systems based on the inverse method~$\IM$ for Parametric Timed Automata (PTAs) augmented with stopwatches~\cite{AHV93,AM02}.
...
When executing the inverse method, \imitator{} takes as input a network of PTAs with stopwatches
