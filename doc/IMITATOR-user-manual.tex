...
\begin{table}[h!]
	...
	{\centering
		\begin{tabular}{ | l | l | c | c | c | }
			...
			% Non-nested CTL
			\hline
			% TODO: update default merge options!
...
A possibly invalid constraint can be synthesized when some options are used: for example, computing the result of \IM{} with the merging enabled (\styleOption{-merge}) % TODO: update
yields a possibly invalid constraint, as it was shown that the merging optimization does not preserve the validity of the result of~\IM{}~\cite{AFS13atva}.
...
%------------------------------------------------------------
Use the merging technique of [AMPP2x] % TODO: update ref
