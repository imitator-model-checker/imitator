...
Exists-until (``EU'' in CTL) denotes that a property holds \emph{until} another property holds.
The second property must eventually hold, and might even hold from the first state, in which case the first property does not need to hold.
...
\begin{table}[h!]
	...
	{\centering
		\begin{tabular}{ | l | l | c | c | c | }
			...
			\hline
			Until           & \styleIMI{E(sp\_1)U(sp\_2)}                  & \cellYes{} & \styleOption{inclusion} \\
