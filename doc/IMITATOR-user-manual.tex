...
\imitator{} will generate a file \stylePath{model-statespace.png}.
...
In this case, \imitator{} outputs a file \stylePath{<input\_file>.png}, which is a graphical output in the PNG format, generated using \gdot{}, corresponding to the trace set.
