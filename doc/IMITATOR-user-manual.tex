...
Our translation preserves \imitator{} semantics, using the following scheme:
\begin{itemize}
...
%------------------------------------------------------------
For algorithms \EFsynth{} and \PRP{}, stops the analysis as soon as one target state is found.
...
(for backward compatibility with versions $< 2.10.1$, replacing ``\styleIMI{invariant}'' with ``\styleIMI{while}'' is still allowed, although it is deprecated)
...
(for backward compatibility with versions $< 2.10.1$, replacing ``\styleIMI{<name>} \styleIMI{:=}'' with ``\styleIMI{<name>} \styleIMI{'} \styleIMI{=}'' is still allowed, although it is deprecated)
...
\newcommand{\FI}{Fundamenta Informormaticae}
