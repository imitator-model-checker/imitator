...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Parametric non-Zeno cycle-freeness checking}\label{ss:mode:Zeno}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Given an \NIPTA{}, \imitator{} synthesizes a parameter constraint such that, for any parameter valuation in that constraint, the system does not contain any cycle, under the non-Zeno assumption~\cite{ANPS17}.
That is, only parameter valuations yielding the absence of non-Zeno cycles are synthesized.
Parameter valuations yielding only Zeno-cycles are ignored.
...
\warningbox{restrictions}{%
	...
	\begin{itemize}
		...
		\item discrete variables may not be supported.
	\end{itemize}
}
