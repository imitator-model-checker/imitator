...
However, the sets of actions, locations and variables are not required to be disjoint.
That is, the same name can be given to a clock, an action and a location.
...
The following words are reserved keywords and cannot be used as names for automata, variables, synchronization labels or locations. 
