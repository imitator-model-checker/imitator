...
\author{\'Etienne Andr\'e, Romain Soulat}
% \date{}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
\imitator{} is a tool for parameter synthesis in timed automata with stopwatches.
...
Sources, binaries for Linux platforms, and installation instructions are available on \imitator{}'s Web page \cite{}.
...
%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%
% Whereas \imitator{} was a prototype written in \python{} calling \hytech{} for the computation of the $\mathit{Post}$ operation, 
\imitator{} is a standalone tool written in \ocaml{}.
...
\imitator{} relies on the Parma Polyhedra Library (PPL)~\cite{bhz08}.
...
\begin{tikzpicture}[scale=0.6]
	...
	% Etiquettes
	\node [etiquette] at (3.5, 5) {\imitator{} (\ocaml{})};
...
Note that the graphical outputs, automatically generated by~\imitator{} in the \code{gif} format, were rewritten in \LaTeX{} in this document.
