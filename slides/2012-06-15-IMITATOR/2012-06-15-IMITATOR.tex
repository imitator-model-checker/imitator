...
% 	\bigskip
	...
	\textbf{\footnotesize{\usebeamercolor[fg]{title} Journ\'ee MeFoSyLoMa -- CosyVerif}}
	
	\textbf{\footnotesize{Universit\'e Paris 13, Sorbonne Paris Cit\'e}}

	\medskip

	\footnotesize{15th June 2012}
	...
	\scriptsize{ $^1$ Universit\'e Paris 13, Sorbonne Paris Cit\'e, LIPN, CNRS, F-93430, Villetaneuse, France}
...
\begin{tikzpicture}[>=stealth', node distance=3cm, semithick]
	...
	\node[contrainte, fill=cv1!30] at (0, -1) (C0) {\centering \begin{tabular}{r @{\,} c @{\,} l }
		$\coulparam{p_1}$ & $\leq$ & $\coulparam{p_2}$ \\
		& & \\
	\end{tabular}
	...
	\node[contrainte, fill=cv2!30] at (2.5, -1) (C1) {\centering \begin{tabular}{r @{\,} c @{\,} l }
		$\coulparam{p_1}$ & $\leq$ & $\coulparam{p_2}$ \\
		$\coulparam{p_1}$ & $\leq$ & $\coulparam{p_3} + \coulparam{p_4}$ \\
	\end{tabular}
	};
	...
	\node[contrainte, fill=cv3!30] at (5, -1) (C2) {\centering \begin{tabular}{r @{\,} c @{\,} l }
		$\coulparam{p_1}$ & $\leq$ & $\coulparam{p_2}$ \\
		$\coulparam{p_1}$ & $\leq$ & $\coulparam{p_3} + \coulparam{p_4}$ \\
		$\coulparam{p_3}$ & $\geq$ & $\coulparam{p_4}$ \\
	\end{tabular}	
	};
	...
	\node[contrainte, fill=cv4!30, draw=couleurbad] at (5, 2) (C3) {\centering \begin{tabular}{r @{\,} c @{\,} l }
		$\coulparam{p_1}$ & $\leq$ & $\coulparam{p_2}$ \\
		$\coulparam{p_1}$ & $\leq$ & $\coulparam{p_3} + \coulparam{p_4}$ \\
		$\textcolor{red}{p_3}$ & $\textcolor{red}{<}$ & $\textcolor{red}{p_4}$ \\
	\end{tabular}	
	};
