<!-- ************************************************************
 * Program examples/Jobshop/maler_4_4.imi
 ...
 ************************************************************ -->
	 ...
	 <attribute name="variables">
		 <attribute name="clocks">
			...
			<attribute name="clock">
				<attribute name="name">x4</attribute>
			</attribute>
			<attribute name="clock">
	 ...
	 <attribute name="constants">
		 <attribute name="parameters">
			...
			<attribute name="parameter">
				<attribute name="name">d31</attribute>
			</attribute>
			<attribute name="parameter">
				<attribute name="name">d32</attribute>
			</attribute>
			<attribute name="parameter">
				<attribute name="name">d33</attribute>
			</attribute>
			<attribute name="parameter">
				<attribute name="name">d34</attribute>
			</attribute>
			<attribute name="parameter">
				<attribute name="name">d41</attribute>
			</attribute>
			<attribute name="parameter">
				<attribute name="name">d42</attribute>
			</attribute>
			<attribute name="parameter">
				<attribute name="name">d43</attribute>
			</attribute>
			<attribute name="parameter">
				<attribute name="name">d44</attribute>
			</attribute>
		</attribute>
	</attribute>
 ...
 ************************************************************ -->
	...
	<node id="0" nodeType="state">
		<attribute name="name">I4</attribute>
		<attribute name="type">
			<attribute name="initialState"/>
		</attribute>
	</node>
	...
	<node id="1" nodeType="state">
		<attribute name="name">J4</attribute>
		<attribute name="invariant">
			<attribute name="boolExpr">
				<attribute name="greaterEqual">
					<attribute name="expr">
	...
	<node id="2" nodeType="state">
		<attribute name="name">K4</attribute>
	</node>
 
	<node id="3" nodeType="state">
		<attribute name="name">L4</attribute>
		<attribute name="invariant">
			<attribute name="boolExpr">
				<attribute name="greaterEqual">
					<attribute name="expr">
	...
	<node id="5" nodeType="state">
		<attribute name="name">N4</attribute>
		<attribute name="invariant">
			<attribute name="boolExpr">
				<attribute name="greaterEqual">
					<attribute name="expr">
	...
	<node id="8" nodeType="state">
		<attribute name="name">End4</attribute>
	</node>
	...
	<arc id="26" arcType="transition" source="1" target="2">
		<!-- Nosync b4 -->
		<attribute name="guard">
			<attribute name="boolExpr">
				<attribute name="equal">
	...
	<arc id="28" arcType="transition" source="3" target="4">
		<!-- Nosync b4 -->
		<attribute name="guard">
			<attribute name="boolExpr">
				<attribute name="equal">
	...
	<arc id="29" arcType="transition" source="4" target="5">
		<!-- Nosync b4 -->
		<attribute name="guard">
			<attribute name="boolExpr">
				<attribute name="equal">
	...
	<arc id="30" arcType="transition" source="5" target="6">
		<!-- Nosync b4 -->
		<attribute name="guard">
			<attribute name="boolExpr">
				<attribute name="equal">
	...
	<arc id="31" arcType="transition" source="6" target="7">
		<!-- Nosync b4 -->
		<attribute name="guard">
			<attribute name="boolExpr">
				<attribute name="equal">
