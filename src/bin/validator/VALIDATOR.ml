...
let () = 
  ...
  | Compare {configs} -> (
    ...
    | [config_a; config_b] -> (
      ...
      let options_a, parsed_property_option_a = ConfigLoader.build_imitator_options_and_property config_a ~validator_options in 
      let options_b, parsed_property_option_b = ConfigLoader.build_imitator_options_and_property config_b ~validator_options in 
  ...
  | Reduce {model_path;configs} ->
    ...
    | [config_a; config_b] -> 
      ...
      let options_a, parsed_property_option_a = ConfigLoader.build_imitator_options_and_property config_a ~model_path ~validator_options in 
      let options_b, parsed_property_option_b = ConfigLoader.build_imitator_options_and_property config_b ~model_path ~validator_options in 
