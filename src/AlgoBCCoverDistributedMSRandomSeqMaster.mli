...
(* Class definition *)
(************************************************************)
class algoBCCoverDistributedMSRandomSeqMaster : HyperRectangle.hyper_rectangle -> int -> (PVal.pval -> AlgoStateBased.algoStateBased) -> AlgoCartoGeneric.tiles_storage ->
