...
(* 		let options = Input.get_options () in *)
	...
	(*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*)
	method private initialize_cartography =
		(* Retrieve the model *)
		let model = Input.get_model () in
		(* Retrieve the v0 *)
		let v0 = Input.get_v0() in
	...
	(*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*)
	method private create_auxiliary_files imitator_result =
		(* Retrieve the input options *)
		let options = Input.get_options () in
...
(*	(*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*)
	...
	(* Processing the result of IM *)
	(*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*)
	method private abstract_and_store_result im_result reference_val =
	...
	(*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*)
	method private process_result imitator_result =
		(* Retrieve the model *)
		let model = Input.get_model () in
...
(*			if model.correctness_condition <> None then(
	...
	(*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*)
	method private update_termination_condition =
...
(* 			); *)
			...
			(* Process result *)
			self#process_result imitator_result;
