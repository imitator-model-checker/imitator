...
(** Classical Behavioral Cartography with exhaustive coverage of integer points [AF10].
    ...
    switching to sequential mode. [ACE14] Master algorithm *)
...
(* Class definition *)
(************************************************************)
class algoBCCoverDistributedMSRandomSeqMaster : AbstractModel.abstract_model -> AbstractProperty.abstract_property -> HyperRectangle.hyper_rectangle -> NumConst.t -> int -> (PVal.pval -> AlgoStateBased.algoStateBased) -> AlgoCartoGeneric.tiles_storage ->
