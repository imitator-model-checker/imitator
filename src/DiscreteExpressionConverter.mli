...
val convert_continuous_update : variable_infos -> parsed_update_type -> ParsingStructure.parsed_global_expression -> DiscreteExpressions.update_type * LinearConstraint.pxd_linear_term
