...
val convert_update : variable_infos -> updates_type -> variable_access -> ParsingStructure.parsed_global_expression -> DiscreteExpressions.variable_update_type * DiscreteExpressions.global_expression
