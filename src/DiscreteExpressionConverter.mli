...
val convert_update : variable_infos -> updates_type -> parsed_update_type -> ParsingStructure.parsed_global_expression -> DiscreteExpressions.update_type * DiscreteExpressions.global_expression
val convert_continuous_update : variable_infos -> parsed_scalar_or_index_update_type -> ParsingStructure.parsed_global_expression -> DiscreteExpressions.update_type * LinearConstraint.pxd_linear_term
