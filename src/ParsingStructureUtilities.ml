...
*)
(*
let traverse_parsed_seq_code_bloc traverse_fun fold_fun (* parsed_seq_code_bloc *) =

    let rec traverse_parsed_seq_code_bloc_rec local_variables parsed_seq_code_bloc =
        fold_fun (List.map (traverse_parsed_instruction local_variables) parsed_seq_code_bloc)

    and traverse_parsed_instruction local_variables = function
        | Parsed_local_decl (variable_name, discrete_type, init_expr, _) ->
            ...
            let traversed_element = Traversed_parsed_local_decl (variable_name, discrete_type, init_expr) in
        ...
        | Parsed_for_loop (variable_name, from_expr, to_expr, loop_dir, inner_bloc, _) ->
            ...
            let traversed_element = Traversed_parsed_for_loop (variable_name, from_expr, to_expr, loop_dir, inner_bloc_result) in
        ...
        | Parsed_while_loop (condition_expr, inner_bloc) ->
            ...
            let traversed_element = Traversed_parsed_while_loop (condition_expr, inner_bloc_result) in
            traverse_fun local_variables traversed_element
        ...
        | Parsed_if (condition_expr, then_bloc, else_bloc_opt) ->
            ...
            let traversed_element = Traversed_parsed_if (condition_expr, then_result, else_result_opt) in
            traverse_fun local_variables traversed_element

        | Parsed_assignment normal_update ->
            let traversed_element = Traversed_parsed_assignment normal_update in
            traverse_fun local_variables traversed_element
