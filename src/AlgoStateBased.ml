...
(*		
		...
		let z_n_minus_1, continuous_guard_n_minus_1, updates_n_minus_1 =
			...
			if n > 0 then(
				...
				let _, _, (continuous_guards_n_minus_1 : LinearConstraint.pxd_linear_constraint list), (updates_n_minus_1 : AbstractModel.clock_updates list) = compute_new_location_guards_updates location_n_minus_1 symbolic_step_n_minus_1.transition in
		...
		let _, _, (continuous_guards_n : LinearConstraint.pxd_linear_constraint list), (updates_n : AbstractModel.clock_updates list) = compute_new_location_guards_updates location_n symbolic_step_n.transition in
