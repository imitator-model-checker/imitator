...
(** define discrete states (global locations) *)
...
val make_global_location_and_local_variables : global_location -> local_variables_table -> global_location_and_local_variables
