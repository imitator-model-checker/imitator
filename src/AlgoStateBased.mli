...
(*------------------------------------------------------------------*)
val get_updates : (string, AbstractModel.fun_definition) Hashtbl.t option -> Location.global_location -> AbstractModel.updates -> AbstractModel.clock_updates * (DiscreteExpressions.discrete_update list)
