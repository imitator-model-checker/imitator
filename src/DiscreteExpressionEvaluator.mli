...
val eval_boolean_expression : functions_table -> discrete_access option -> boolean_expression -> bool
val eval_discrete_boolean_expression : functions_table -> discrete_access option -> discrete_boolean_expression -> bool

(* Check if a nonlinear constraint is satisfied *)
val check_nonlinear_constraint : functions_table -> DiscreteExpressions.discrete_access -> nonlinear_constraint -> bool
...
val match_state_predicate : functions_table -> discrete_access -> (automaton_index -> location_index -> bool) -> Location.global_location -> AbstractProperty.state_predicate-> bool
