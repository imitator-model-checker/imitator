...
val resolve_constraints : variable_infos -> signature_constraint -> signature -> parsed_boolean_expression list -> (constraint_name * resolved_constraint) list * (constraint_name * resolved_constraint) list
