...
sig
    ...
    val is_typed_boolean_expression_satisfied : discrete_valuation -> typed_boolean_expression -> bool
    val check_typed_discrete_boolean_expression : discrete_valuation -> typed_discrete_boolean_expression -> bool
