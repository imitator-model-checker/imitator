...
(* Class definition *)
(************************************************************)
class algoBCCover : AbstractModel.abstract_model -> Options.imitator_options -> HyperRectangle.hyper_rectangle -> NumConst.t -> (PVal.pval -> AlgoStateBased.algoStateBased) -> tiles_storage ->
