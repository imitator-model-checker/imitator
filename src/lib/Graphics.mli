...
(** All graphics handling (cartography, trace set…) *)
...
val draw_concrete_run : AbstractModel.abstract_model -> StateSpace.concrete_run -> string -> unit
val draw_impossible_concrete_run : AbstractModel.abstract_model -> StateSpace.impossible_concrete_run -> string -> unit
