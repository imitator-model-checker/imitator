...
/************************************************************/
	...
	/* Stategies */
	/*------------------------------------------------------------*/
	| CT_BEG_COALITION name_list CT_END_COALITION property { Unexpanded_Parsed_Strategies ($2,$4) }

	| CT_BEG_COALITION name_list_paren CT_END_COALITION property { Unexpanded_Parsed_Large_Strategies ($2,$4) }
