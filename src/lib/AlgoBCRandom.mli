...
(* Class definition *)
(************************************************************)
class algoBCRandom : AbstractModel.abstract_model -> Options.imitator_options -> HyperRectangle.hyper_rectangle -> NumConst.t -> int -> (PVal.pval -> AlgoStateBased.algoStateBased) -> tiles_storage ->
