...
(************************************************************)
(************************************************************)
class algoGeneralizedAccLoopSynth (model : AbstractModel.abstract_model) (options : Options.imitator_options) (state_predicate_list : AbstractProperty.state_predicate list) =
	object (_(*self*)) inherit algoLoopSynth model options (*as super*)
