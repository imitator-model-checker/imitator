...
let controller_synthesis (system_model : AbstractModel.abstract_model) (state_space : stateSpace) (options : Options.imitator_options) (strategy : locationStrategyMap) ~callback ~export_controller =
