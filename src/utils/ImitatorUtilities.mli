...
(** Useful and general functions for IMITATOR. *)
...
val print_message_lazy : verbose_mode -> string Lazy.t -> unit
...
val log_detail_lazy : verbose_mode -> string -> JsonFormatter.json_element Lazy.t -> unit
...
val log_detail_in_array_lazy : verbose_mode -> string -> JsonFormatter.json_element Lazy.t -> unit
