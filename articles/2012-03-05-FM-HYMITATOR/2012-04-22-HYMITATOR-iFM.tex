...
The behavioral cartography has been slightly modified. For hybrid automata, there is no restriction of the clock constraints to integer coefficients. For this reason, instead of considering only integer points as starting points for the inverse method, an arbitrary rational step size can be used for each parameter dimension.
