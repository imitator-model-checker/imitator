...
\newcommand{\imitator}{IMITATOR} % \textsc{Imitator}
...
\begin{abstract}
	...
	A common problem for hybrid systems is the good parameters problem, which consists in identifying a set of parameter valuations guaranteeing a certain good behavior of a system.
	We introduce here \mbox{\hymitator{}}, a tool for efficient parameter synthesis for hybrid automata, providing hybrid systems with a quantitative measure of their robustness.
\end{abstract}
...
\begin{figure}[t]
	\centering
	\newcommand{\graphwidth}{3.68cm}
	\subfigure[Reachable states]{
		\includegraphics[width=\graphwidth]{plot_t_x1}
		\label{fig:plot1}
	}
%     \includegraphics[width=3.5cm]{plot_t_x2} \;
%     \includegraphics[width=3.5cm]{plot_t_x3}
	\subfigure[Trajectories]{
		\includegraphics[width=\graphwidth]{navigation_map.pdf}
		\label{fig:plot2}
	}
	\subfigure[Behavioral cartography]{
		\includegraphics[height=\graphwidth]{rhb_cart2.pdf}
		\label{fig:plot3}
	}
%     \label{fig:plot_zone}
%   } 
