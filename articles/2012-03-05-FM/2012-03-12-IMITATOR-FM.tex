...
BC outputs the set of tiles and we check for one point of each tile whether the system is schedulable or not.
...
\begin{figure}[!ht]
	...
	\label{fig:carto}
\end{figure}
Note that the full parametric space is covered after only 20 applications of $\IM$.
