...
loc l_x0_q_2 : while x_q_2 <= delta0_u_q_2 wait {}
	...
	when s = 1-0   & q_1 = 1 sync s_down do{ x_q_2'=0 } goto l_x1_q_2;
	when  q_1 = 1  sync q_1_up goto l_x0_q_2;
	when q_1 = 1-0   & s = 1 sync q_1_down do{ x_q_2'=0 } goto l_x1_q_2;
...
loc l_x1_q_2 : while x_q_2 <= delta1_u_q_2 wait {}
	...
	when  s = 1  sync s_up goto l_x1_q_2;
	when  s = 1-0   & q_1 = 0 sync s_down goto l_x1_q_2;
	when  s = 1-1   & q_1 = 0 sync s_up goto l_x1_q_2;
	when s = 1-1   & q_1 = 1 sync s_up do{ x_q_2'=0 } goto l_x0_q_2;
	when  q_1 = 0  sync q_1_down goto l_x1_q_2;
	when  q_1 = 1  sync q_1_up goto l_x1_q_2;
	when  q_1 = 1-0   & s = 0 sync q_1_down goto l_x1_q_2;
	when  q_1 = 1-1   & s = 0 sync q_1_up goto l_x1_q_2;
	when q_1 = 1-1   & s = 1 sync q_1_up do{ x_q_2'=0 } goto l_x0_q_2;
...
loc l_f_q_2 : while True wait {}
	...
	when  s = 1-0   & q_1 = 0 sync s_down goto l_f_q_2;
	when  s = 1-1   & q_1 = 0 sync s_up goto l_f_q_2;
	when s = 1-0   & q_1 = 1 sync s_down do{ x_q_2'=0 } goto l_x1_q_2;
	when s = 1-1   & q_1 = 1 sync s_up do{ x_q_2'=0 } goto l_x0_q_2;
	when  q_1 = 0  sync q_1_down goto l_f_q_2;
	when  q_1 = 1  sync q_1_up goto l_f_q_2;
	when  q_1 = 1-0   & s = 0 sync q_1_down goto l_f_q_2;
	when  q_1 = 1-1   & s = 0 sync q_1_up goto l_f_q_2;
	when q_1 = 1-0   & s = 1 sync q_1_down do{ x_q_2'=0 } goto l_x1_q_2;
	when q_1 = 1-1   & s = 1 sync q_1_up do{ x_q_2'=0 } goto l_x0_q_2;
...
loc l_x0_q_1 : while x_q_1 <= delta0_u_q_1 wait {}
	...
	when r = 1-0   & q_2 = 1 sync r_down do{ x_q_1'=0 } goto l_x1_q_1;
	when  q_2 = 1  sync q_2_up goto l_x0_q_1;
	when q_2 = 1-0   & r = 1 sync q_2_down do{ x_q_1'=0 } goto l_x1_q_1;
...
loc l_x1_q_1 : while x_q_1 <= delta1_u_q_1 wait {}
	...
	when  r = 1  sync r_up goto l_x1_q_1;
	when  r = 1-0   & q_2 = 0 sync r_down goto l_x1_q_1;
	when  r = 1-1   & q_2 = 0 sync r_up goto l_x1_q_1;
	when r = 1-1   & q_2 = 1 sync r_up do{ x_q_1'=0 } goto l_x0_q_1;
	when  q_2 = 0  sync q_2_down goto l_x1_q_1;
	when  q_2 = 1  sync q_2_up goto l_x1_q_1;
	when  q_2 = 1-0   & r = 0 sync q_2_down goto l_x1_q_1;
	when  q_2 = 1-1   & r = 0 sync q_2_up goto l_x1_q_1;
	when q_2 = 1-1   & r = 1 sync q_2_up do{ x_q_1'=0 } goto l_x0_q_1;
...
loc l_f_q_1 : while True wait {}
	...
	when  r = 1-0   & q_2 = 0 sync r_down goto l_f_q_1;
	when  r = 1-1   & q_2 = 0 sync r_up goto l_f_q_1;
	when r = 1-0   & q_2 = 1 sync r_down do{ x_q_1'=0 } goto l_x1_q_1;
	when r = 1-1   & q_2 = 1 sync r_up do{ x_q_1'=0 } goto l_x0_q_1;
	when  q_2 = 0  sync q_2_down goto l_f_q_1;
	when  q_2 = 1  sync q_2_up goto l_f_q_1;
	when  q_2 = 1-0   & r = 0 sync q_2_down goto l_f_q_1;
	when  q_2 = 1-1   & r = 0 sync q_2_up goto l_f_q_1;
	when q_2 = 1-0   & r = 1 sync q_2_down do{ x_q_1'=0 } goto l_x1_q_1;
	when q_2 = 1-1   & r = 1 sync q_2_up do{ x_q_1'=0 } goto l_x0_q_1;
